...
export type InfiniteScrollActions = { type: "add_to_set", vals: string[] } | {type: "concat_to_array", vals: NotifyClientTypes.NotifyMessage[] }

export const infiniteScrollReducer = (state: InfiniteScrollNotificationState, action: InfiniteScrollActions): InfiniteScrollNotificationState => {
  switch(action.type) {
