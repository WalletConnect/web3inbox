...
export const useColorModeValue = (mode: SettingsContextSimpleState['mode']) => {
  ...
  const colors = {
    dark: {
      ...
      accent2: 'hsla(211, 90%, 50%, 0.3)',
      accent3: 'hsla(211, 90%, 50%, 0.08)',
    ...
    light: {
      ...
      accent1: 'hsla(178, 90%, 32%, 1)',
      accent2: 'hsla(178, 90%, 32%, 0.3)',
      accent3: 'hsla(178, 90%, 32%, 0.08)',
      error1: '#ED4747',
  ...
  const colorModeVariables = {
    ...
    '--accent-color-3': colors[specifiedMode].accent3,
